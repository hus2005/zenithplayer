...
import { StreamFormat, VideoPlayer } from '@zenithplayer/shared/interfaces';
...
const MPV_COMPATIBLE_PLAYER_TIP =
    'IINA can be launched as an MPV-compatible player on macOS, but use its executable path, such as /Applications/IINA.app/Contents/MacOS/iina-cli or /Applications/IINA.app/Contents/MacOS/IINA. Zenith Player controls, position polling, and reuse-instance behavior are guaranteed only for MPV IPC.';
