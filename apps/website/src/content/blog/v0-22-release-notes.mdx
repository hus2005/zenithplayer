...
description: Zenith Player v0.22 brings opt-in TMDB metadata enrichment, redesigned two-state movie & series pages, embedded MPV on Windows and Linux, a built-in desktop auto-updater, global search across all sources, and a reworked live EPG timeline.
featured: true
pubDate: 2026-07-05
author: zenith
heroImage: /zenithplayer/blog/v0-22/wide-changelog.jpg
tags:
    - release
    - release-notes
    - v0.22
...
Zenith Player **v0.22** is out — and it's a big one.
...
<BlogImageSlider
    images={[
        {
            src: '/zenithplayer/blog/v0-22/feature-mosaic.webp',
        ...
        {
            src: '/zenithplayer/blog/v0-22/wide-changelog.webp',
        ...
        {
            src: '/zenithplayer/blog/v0-22/epg-timeline.webp',
            alt: 'The reworked live EPG horizontal timeline under the player',
            caption: 'The live EPG panel is now a horizontal timeline.',
        },
        {
            src: '/zenithplayer/blog/v0-22/version-square.webp',
            alt: 'Zenith Player v0.22 version card with the dashboard',
...
The screenshots and posters shown here are for demonstration purposes only. Zenith Player is a pure media player — it does not provide, host, bundle, or distribute any streams, playlists, or media content. You bring your own sources; the app just plays them.
</Alert>
...
This was tracked across [#1123](https://github.com/hus2005/zenithplayer/pull/1123), [#1126](https://github.com/hus2005/zenithplayer/pull/1126) and [#1132](https://github.com/hus2005/zenithplayer/pull/1132).
...
Shipped in [#1127](https://github.com/hus2005/zenithplayer/pull/1127).
...
This release also fixes a crash in the packaged updater where a missing dependency could take down the app on launch ([#1103](https://github.com/hus2005/zenithplayer/issues/1103)).
...
The timeline landed in [#1102](https://github.com/hus2005/zenithplayer/pull/1102), with the vertical list view added in [#1115](https://github.com/hus2005/zenithplayer/pull/1115).
...
- The catch-up **Watch** button now works from the unified live tab, with clear errors when a stream can't be resolved ([#1133](https://github.com/hus2005/zenithplayer/pull/1133)).
    ...
    links={[
        {
            ...
            href: 'https://github.com/hus2005/zenithplayer/releases/tag/v0.22.0',
            hint: 'Official binaries for macOS, Windows and Linux.',
            icon: 'download',
        },
        {
            label: 'Full Changelog',
            href: 'https://github.com/hus2005/zenithplayer/compare/v0.21.0...v0.22.0',
