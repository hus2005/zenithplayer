...
description: Zenith Player v0.18 brings a new playlist switcher UI, large EPG improvements, Xtream and Stalker updates, and multiple UX fixes across the app.
featured: false
pubDate: 2026-01-14
author: zenith
heroImage: /zenithplayer/blog/zenithplayer-v18.jpeg
tags:
- release
- release-notes
- v0.18
  ...
  links={[
    {
      ...
      href: 'https://github.com/hus2005/zenithplayer/releases/tag/v0.18.0',
