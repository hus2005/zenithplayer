...
description: Reusable MDX components for Zenith Player blog posts including alerts, CTA buttons, and terminal command blocks.
pubDate: 2026-02-15
author: zenith
tags:
- blog
...
<CopyCommand title="One-line fix" command="xattr -c /Applications/Zenith Player.app" />
...
<PostButton
  href="/zenithplayer/blog/v0-18-release-notes/"
...
<ImageGallery
  ...
  images={[
    {
      src: '/zenithplayer/blog/zenithplayer-v18.jpeg',
      alt: 'Zenith Player v0.18 UI screenshot',
      caption: 'v0.18 interface update',
    },
    {
      src: '/zenithplayer/blog/macos-app-damaged.jpg',
...
<BlogImageSlider
  images={[
    ...
    {
      src: '/zenithplayer/blog/epg.png',
      alt: 'EPG guide screenshot',
      caption: 'Electronic Program Guide screen in Zenith Player.',
    },
  ]}
/>
