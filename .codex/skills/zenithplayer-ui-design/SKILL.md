---
name: zenithplayer-ui-design
description: Repository-specific UI design guidance for Zenith Player channel rows, EPG views, settings surfaces, shared selection styles, and light/dark theme consistency.
---

# Zenith Player UI Design

Use this skill when changing user-visible Angular UI in the Zenith Player app, especially channel lists, EPG panels, settings, playlist surfaces, and portal shared components.
...
4. Prefer existing components from `@zenithplayer/ui/components`, `@zenithplayer/portal/shared/ui`, and `@zenithplayer/ui/epg`.
